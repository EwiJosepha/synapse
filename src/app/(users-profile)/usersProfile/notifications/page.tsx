...
function Notifications() {
  return (
    <div>
      <div className=' flex flex-col gap-4 pt-3 pr-3'>
        <div className='md:flex flex flex-col gap-4 md:justify-center md:items-center '>
        ...
        <div className='flex flex-col gap-4 pl-4 w-[100%]'>
          <div className="mb-4 md:w-[65%] text-white text-justify">
          ...
          <div className="mb-4  md:w-[65%] text-white">
