    ...
    <div>
      <div className=' flex flex-col gap-4'>
        ...
        <div className=' flex flex-col gap-3 w-[90%] pl-3 text-white text-sm'>
          ...
          <button className='text-white lg:text-xl bg-pink-500 shadow-md  md:px-3 py-1 rounded-md hover:text-black'>
            Archive all chats
          </button>
          <p className='text-sm text-justify'>You will recieve all messages from Archives</p>
          <button className='text-white shadow-md lg:text-xl hover:text-black bg-pink-500 md:px-3 py-1 rounded-lg'>
            clear  messages
          </button>
          <p>Delete all messagees from chats and groups</p>
          <button className='text-white shadow-md lg:text-xl  bg-pink-500 md:px-3 py-1 rounded-lg hover:text-black'>
            Delete chats
          </button>
