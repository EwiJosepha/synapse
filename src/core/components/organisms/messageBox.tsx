...
const MessageBox: React.FC = () => {
  ...
  // return (
  //   <div className="bg-white shadow-md rounded-md p-4 relative h-screen flex flex-col sm:p-6">
  //     <h2 className="text-xl font-bold mb-4">Message Box</h2>
  //     <div className="flex-1 overflow-y-auto flex flex-col space-y-2 mb-20 sm:mb-24">
  //       {messages.map((message) => (
  //         <div
  //           key={message.id}
  //           className={`px-4 py-2 rounded-md sm:px-6 ${
  //             message.id % 2 === 0 ? 'bg-gray-100' : 'bg-gray-200'
  //           }`}
  //         >
  //           {message.text}{' '}
  ...
  //       ))}
  //     </div>
  //     <div className="flex space-x-2 fixed bottom-0 left-0 right-0 bg-white py-4 px-4 sm:px-6 sm:py-6">
  //       <button
  //         onClick={toggleEmojiPicker}
  //         className="bg-gray-200 hover:bg-gray-300 text-gray-700 font-bold py-2 px-4 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 sm:py-3 sm:px-5"
  //       >
  //         <Smile />
  //       </button>
  //       <input
  ...
  //         className="flex-1 px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none sm:px-6 sm:py-3"
  //       />
  //       {showEmojiPicker && (
  //         <div className="absolute bottom-[60px] left-0 bg-white shadow-lg rounded-md p-2 z-10 grid grid-cols-8 gap-2 sm:bottom-[70px] sm:p-3">
  //           {emojiList.map((emoji, index) => (
  //             <button
  //               key={index}
  //               onClick={() => handleEmojiClick(emoji)}
  //               className="text-2xl hover:bg-gray-200 rounded-md p-2 sm:p-3"
  //             >
  //               {emoji}
  //             </button>
  //           ))}
  ...
  //         className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 sm:py-3 sm:px-5"
  //       >
  //         <SendHorizonal />
  //       </button>
  //     </div>
